...
import 'package:sparrow/features/txApp/domain/interface/general_ressponse_body.dart';
import 'package:sparrow/features/txApp/domain/object/general_callback_result.dart';

base class TxAppRemoteDataSource
    extends RemoteDataSource<GeneralResponseBody, Map<String, dynamic>> {
  @override
  final String baseUrl = 'https://baseonemoney.000webhostapp.com/req/';
